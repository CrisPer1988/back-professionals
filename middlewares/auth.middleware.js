...
exports.protectProfessional = catchAsync(async(req, res, next) => {
    let token;
    ...
    if(professional.passwordChangedAt) {
        const changedTimeStamp = parseInt(professional.passwordChangedAt.getTime() / 1000, 10);
    ...
    req.sessionProfessional = professional
    next()
})
